...
test('SignupForm to be rendered with needed element', () => {
  ...
  let signUpComponent = render(<SignUpForm handleFormSubmit={handleFormSubmit} />);
...
test('SignupForm submits value of form on submit', async () => {
  ...
  let signUpComponent = render(<SignUpForm handleFormSubmit={handleFormSubmit}></SignUpForm>);
